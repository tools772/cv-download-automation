...
async function loadOAuthClient(config: InstahyreConfig): Promise<OAuthClientConfig> {
...
export async function runGoogleOAuthSetup(config: InstahyreConfig): Promise<string> {
...
export async function getOAuthAccessToken(config: InstahyreConfig): Promise<string> {
...
async function loadToken(config: InstahyreConfig): Promise<OAuthTokenFile> {
